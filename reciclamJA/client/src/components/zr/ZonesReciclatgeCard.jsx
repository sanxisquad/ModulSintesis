      ...
      {zones.empresa?.nom && (
        <div className="mb-3 pt-2 border-t border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-gray-700 font-medium">{zones.empresa.nom}</p>
              {isSuperAdmin && zones.empresa.email && (
                <p className="text-xs text-gray-500">{zones.empresa.email}</p>
              )}
            </div>
          </div>
        </div>
